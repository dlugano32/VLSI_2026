...
module tb_freq_meas ();
    ...
    parameter int WINDOW_LEN = 200000;

    //! Clock periods
    parameter time CLK_REF_PERIOD = 5ns; //! 200 MHz
    parameter time CLK_IN_PERIOD  = 1ns; //! 1GHz
    ...
    freq_meas #(
        ...
        .i_start      (i_start),
        .i_rst_ref_n  (i_rst_ref_n),
        .i_rst_in_n   (i_rst_in_n),
        .i_clk_ref    (i_clk_ref),
        .i_clk_in     (i_clk_in)
    );
    ...
    initial begin
        ...
        //! Model the two domain resets generated by the top-level reset
        //! synchronizers. Each one is released after its own active edge.
        fork
            begin
